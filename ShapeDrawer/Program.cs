    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            do
            {
                ...
                {
                    myDrawing.Save("D:/Projects/C_sharp/ShapeDrawer/TextFolder.txt");
                }
                if (SplashKit.KeyDown(KeyCode.OKey))
                {
                    try
                    {
                        myDrawing.Load("D:/Projects/C_sharp/ShapeDrawer/TextFolder.txt");
                    } catch(Exception e)
                    {
                        Console.Error.WriteLine("Error loading file:{0}", e);
                    }
                }
